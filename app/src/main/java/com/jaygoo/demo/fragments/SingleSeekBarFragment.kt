...
class SingleSeekBarFragment : BaseFragment() {
    ...
    override fun initView(view: View) {
        val sb_single1 = view.findViewById<RangeSeekBar>(R.id.sb_single1)
        val sb_single2 = view.findViewById<RangeSeekBar>(R.id.sb_single2)
        val sb_single3 = view.findViewById<RangeSeekBar>(R.id.sb_single3)
        val sb_single4 = view.findViewById<RangeSeekBar>(R.id.sb_single4)
        val sb_single5 = view.findViewById<RangeSeekBar>(R.id.sb_single5)
        val sb_single6 = view.findViewById<RangeSeekBar>(R.id.sb_single6)
